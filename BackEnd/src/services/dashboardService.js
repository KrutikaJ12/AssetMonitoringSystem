...
async function getDashboardData(userId, customerId) {
    ...
    return {
        ...
        runningAssets: summary?.RunningAssets || 0,
        idleAssets: summary?.IdleAssets || 0,
        stoppedAssets: summary?.StoppedAssets || 0,
        offlineAssets: summary?.OfflineAssets || 0,
        unknownAssets: summary?.UnknownAssets || 0,

        todayEngineMinutes: summary?.TodayEngineMinutes || 0,
        todayWorkingMinutes: summary?.TodayWorkingMinutes || 0,
        todayIdleMinutes: summary?.TodayIdleMinutes || 0,
        todayDistanceKm: summary?.TodayDistanceKm || 0
    };
}
...
async function getLiveAssets({
    ...
    return await dashboardRepository.getLiveAssets({
        userId,
        customerId,
        status,
        siteId,
